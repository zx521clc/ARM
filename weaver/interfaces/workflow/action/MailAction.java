...
import weaver.hrm.excelimport.HrmLoaction;
...
public class MailAction extends BaseBean implements Action {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try{
            ...
            if (rs.next()) {
                ...
                familyname=Util.null2String(rs.getString("familyname"));
                armcbzx=Util.null2String(rs.getString("armcbzx"));
            }
            ...
            for(String type:types) {
                ...
                if (type.equalsIgnoreCase("template1")) {
                    ...
                    params.put("ename",xm);
                    params.put("name",new ResourceComInfo().getLastnames(dyry));
                    writeLog("to:"+to[0]);
