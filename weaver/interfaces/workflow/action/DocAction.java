...
public class DocAction extends BaseBean implements Action {
    @Override
    public String execute(RequestInfo requestInfo) {
        ...
        if(ndam.trim().equalsIgnoreCase("")){
            ...
            sql="select mouldid,seccategory from workflow_mould where visible=1 and mouldtype=4 and workflowid="+workflowid+" and selectvalue="+fieldvalue1;
            rs.executeQuery(sql);
            String mouldid="";
            int seccategory=-1;
            if(rs.next()){
